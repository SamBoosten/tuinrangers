<?php
/**
 * The Template for displaying Background Cover Layout
 *
 * This template can be overridden by copying it to yourtheme/divi-blog-extras/layouts/background_cover.php.
 *
...
// Post Meta.
if ( ( 'on' === $show_categories && ! empty( $post_term_list ) ) || 'on' === $show_date ) {
	$output .= sprintf(
		'<p class="post-meta">%1$s %2$s</p>',
		(
...
// Post Meta.
if ( 'on' === $show_author || 'on' === $show_comments || 'on' === $show_read_time ) {
	$output .= sprintf(
