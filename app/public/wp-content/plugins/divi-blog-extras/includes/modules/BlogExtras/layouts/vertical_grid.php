<?php
/**
 * The Template for displaying Masonry Vertical Grid Layout
 *
 * This template can be overridden by copying it to yourtheme/divi-blog-extras/layouts/vertical_grid.php.
 *
